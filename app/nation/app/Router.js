$(function() {
    App.Router = new(Backbone.Router.extend({
        ...
        SelectMembers: function(pId, type) {
            $('#invitationdiv').fadeIn(1000)
            ...
            $('#ageGroupSelect').append("<option value='1-20'>1-20</option><option value='20-30 years'>20-30</option><option value='30-40'>30-40</option><option value='40-50'>40-50</option><option value='Above 50'>Above 50</option>");
            $('#addQuestion').css('pointer-events','none');
        },
