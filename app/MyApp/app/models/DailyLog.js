$(function() {
    ...
    App.Models.DailyLog = Backbone.Model.extend({
        ...
        schema: {
            ...
            "female_new_signups": 'number',//Count of new male sign-ups in a day
            "male_new_signups": 'number',//Count of new female sign-ups in a day
            ...
            "resources_opened": [],//Ids of opened resources in a day
