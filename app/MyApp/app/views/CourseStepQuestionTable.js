$(function() {
    ...
    App.Views.CourseStepQuestionTable = Backbone.View.extend({
        ...
        render: function() {
            /*this.courseStepModel = new App.Models.CourseStep;
            this.courseStepModel.id = this.Id;
            this.courseStepModel.fetch({async: false});
            this.questionArray = this.courseStepModel.get("questionslist"); */
            this.addAll()
        }
