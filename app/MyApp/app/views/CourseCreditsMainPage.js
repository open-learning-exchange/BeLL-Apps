...
$(function () {
    ...
    App.Views.CourseCreditsMainPage = Backbone.View.extend({
        ...
        add: function (courseModel) {
            this.$el.append('<tr><td>' + courseModel.get('CourseTitle')+ '</td><td><a class="btn btn-success" href="#badges/edit/' + courseModel.get('_id') + '" style="margin-left:10px" id="detailsButton"  >' + "Open" + '</a></td></tr>')
        },
        render: function () {
