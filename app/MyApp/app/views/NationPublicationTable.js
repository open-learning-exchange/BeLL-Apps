    $(function () {
        ...
        App.Views.NationPublicationTable = Backbone.View.extend({
            authorName: null,
            tagName: "table",
                    ...
                    success: function (json) {
                        ...
                        /*if (keys != '') {
                            keys = keys.substring(0, keys.length - 1);
                             console.log(keys)*/
                            _.each(json.rows,function(row){ 
                                var pubsForCommunityUrl = 'http://' + row.doc.createrNationName + ':' + nationPassword + '@' + row.doc.createrNationUrl +
                                    '/publications/_all_docs?include_docs=true&keys=["' + row.doc.publicationId + '"]';
                                $.ajax({
            ...
            syncCourses:function(pubDistributionID, publicationToSync){
                ...
                var nationUrl = publicationToSync.createrNationUrl,
                nationName = publicationToSync.createrNationName;
                ...
                var that=this;
                $.couch.login({
                    name: App.configuration.get('nationName'),
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                    ...
                                    success: function (response) {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (response) {
                                                ...
                                                success: function (response) {
                                                var nation_Url = 'http://' + nationName + ':' + App.password + '@' + nationUrl +
                                                            ...
                                                            $.couch.db("publications").saveDoc(publicationDoc, {
                                                                success: function (response) {
                                                                    ...
                                                                    $.ajax({
                                                                        ...
                                                                        data: JSON.stringify({
                                                                            "source": "publications",
                                                                            "target": 'http://' + nationName + ':oleoleole@' + nationUrl + '/publications',
                              ...
                              /*                          var communitycode = App.configuration.get('code');
                                                        $.ajax({
                                                            url:'http://' + nationName + ':oleoleole@' +nationUrl= + '/community/_design/bell/_view/getCommunityByCode?_include_docstrue',
                                                            type: 'GET',
                                                            dataType: 'jsonp',
