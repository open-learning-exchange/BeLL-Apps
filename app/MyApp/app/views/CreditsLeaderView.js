...
$(function () {
    ...
    App.Views.CreditsLeaderView = Backbone.View.extend({
        ...
        add: function (jsonModel) {
            ...
            this.$el.append('<tr><td>' + jsonModel.memberName+ '</td><td>' + "Paper"+ '</td><td>' + date+ '</td><td>' +jsonModel.courseModel.get('CourseTitle') + '</td><td>' + jsonModel.stepNo+ '</td><td><a class="btn btn-success" href="#creditsDetails/' + jsonModel.courseModel.get('_id') + '/' + jsonModel.memberId + '" style="margin-left:10px" id="detailsButton"  >' + "Open" + '</a></td></tr>')
        },
        render: function () {
            var that = this;
