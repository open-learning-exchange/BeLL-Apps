...
$(function() {
    ...
    App.Collections.SurveyAnswers = Backbone.Collection.extend({

        //model: App.Models.Question,
        url: function() {
            if (this.keys != 'undefined')
                return App.Server + '/surveyanswers/_all_docs?include_docs=true&keys=[' + this.keys + ']'
            else
                return App.Server + '/surveyanswers/_all_docs?include_docs=true'
