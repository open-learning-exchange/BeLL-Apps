  ...
  App.Views.BecomeMemberForm = Backbone.View.extend({
    ...
    setForm: function() {
      ...
      this.model.once('sync', function() {
        ...
        $.cookie('Member.login',that.model.get("login"),{path:"/apps/_design/bell/lms"})
        $.cookie('Member._id', that.model.get("_id"),{path:"/apps/_design/bell/lms"})
        $.cookie('Member.login', that.model.get("login"),{path:"/apps/_design/bell/personal"})
        $.cookie('Member._id', that.model.get("_id"),{path:"/apps/_design/bell/personal"})
