$(function () {
    App.Router = new(Backbone.Router.extend({
        ...
        getIds: function () {
            var a = new App.Collections.ScriptCollection({
            ...
            a = new App.Collections.ScriptCollection({
                model: new App.Models.membercourseprogress,
                db: "membercourseprogress",
                swtch: 0
            })
            a.fetch({
                async: false
            ...
            a = new App.Collections.ScriptCollection({
                model: new App.Models.CourseStep,
                db: "coursestep",
                swtch: 0
            })
            a.fetch({
        ...
        runscript: function () {
            ...
            for (var i = 0; i < App.idss.length; i++) {
                ...
                grp.once('sync', function (e) {
                    ...
                    var results = new App.Collections.ScriptCollection({
                        model: new App.Models.membercourseprogress,
                        db: "membercourseprogress",
                        swtch: 1,
                        courseId: App.idss[0]
