$(function() {
  ...
  App.Views.GroupAssignmentsTable = Backbone.View.extend({
    ...
    template: _.template($('#template-GroupAssignmentsTable').html()),
    ...
    addOne: function(model){
      ...
      var assignmentId = (_.has(this.resourceIdToAssignmentIdMap, model.id)) 
        ? this.resourceIdToAssignmentIdMap[model.id]
        : false
