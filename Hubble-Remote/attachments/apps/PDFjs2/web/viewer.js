...
//#endif
  ...
  // Pouch("hammock.treehouse.su/hub-8968fd5708c6c1378ca086410804e410").getAttachment("8968fd5708c6c1378ca086410804f0ab/small.pdf", function(err, res) {
  Pouch($.url().fparam("pouch")).getAttachment($.url().fparam("pouchAttachment"), function(err, res) {
    var pouchAttachment = window.URL.createObjectURL(res);
    console.log(pouchAttachment)
//#if (FIREFOX || MOZCENTRAL)
//PDFView.setTitleUsingUrl(pouchAttachment);
//PDFView.initPassiveLoading();
//return;
//#endif

//#if !B2G
  PDFView.open(pouchAttachment, 0);
//#endif
